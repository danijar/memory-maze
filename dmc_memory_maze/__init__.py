...
try:
    ...
    for key, dm_task in sizes.items():
        ...
        register(id=f'MemoryMaze-{key}-Oracle-Top-v0', entry_point=f(_make_gym_env, dm_task, global_observables=True, show_path=True, camera_resolution=256, top_camera=True))
